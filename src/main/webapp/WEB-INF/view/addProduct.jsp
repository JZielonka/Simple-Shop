...
<div class="container-wrapper">
    ...
    <div class="form-group">
        <label for="unitInStock">Units in Stock</label><form:errors path="unitInStock" cssStyle="color: red"/>
    ...
    <a href="<spring:url value="/productInventory"/>" class="btn btn-default">Cancel</a>
